...
func (*Request) Descriptor() ([]byte, []int) {
	return fileDescriptor_request_224cd0a37c9476b3, []int{0}
}
...
func (*Request_DRKeyStoreGet) Descriptor() ([]byte, []int) {
	return fileDescriptor_request_224cd0a37c9476b3, []int{0, 0}
}
...
func (*Request_DRKeyStorePut) Descriptor() ([]byte, []int) {
	return fileDescriptor_request_224cd0a37c9476b3, []int{0, 1}
}
...
func (*Request_DRKeyStoreDeleteMK) Descriptor() ([]byte, []int) {
	return fileDescriptor_request_224cd0a37c9476b3, []int{0, 2}
}
...
func (*Request_DRKeyStoreDeleteKeys) Descriptor() ([]byte, []int) {
	return fileDescriptor_request_224cd0a37c9476b3, []int{0, 3}
}
...
func (*Request_DRKeyStoreCount) Descriptor() ([]byte, []int) {
	return fileDescriptor_request_224cd0a37c9476b3, []int{0, 4}
}
...
func init() { proto.RegisterFile("api/pb/request.proto", fileDescriptor_request_224cd0a37c9476b3) }

var fileDescriptor_request_224cd0a37c9476b3 = []byte{
	// 313 bytes of a gzipped FileDescriptorProto
	,
}
